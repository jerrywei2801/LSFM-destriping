...
# Parameters of the input images, decided by the testing data
Number = 3 # total number of images tested
channels = 3
height = 2048 # height of the testing images
width = 2048 # width of the testing images
dataset_path = "./Data/"
